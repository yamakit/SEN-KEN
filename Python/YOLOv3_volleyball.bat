...
rem 各競技のフォルダへ移動
cd D:\htdocs\SEN-KEN\2021SEN_KEN\volleyball\2

rem ffmpegで作成した連番画像を保存するフォルダを作成
mkdir %1

rem 作成したフォルダへの連番画像を作成するコマンド
ffmpeg -i D:\htdocs\SEN-KEN\2021SEN_KEN\volleyball\2\%1.MOV -r 30 D:\htdocs\SEN-KEN\2021SEN_KEN\volleyball\2\%1\%%05d.jpg 
